...
public class InterpreterCLI {
    ...
    public static List<IStatement> barrierExample() {
        List<IStatement> programs = new ArrayList<>();
                            ...
                            new CompStatement(
                                ...
                                new CompStatement(
                                    ...
                                    new CompStatement(
                                        ...
                                        new CompStatement(
                                            new NewBarrierStatement("cnt", new HeapReadExpression(new VarExpression("v2"))),
                                            new CompStatement(
                                                new ForkStatement(
                                                    new CompStatement(
                                                        ...
                                                        new CompStatement(
                                                            new HeapWriteStatement("v1",
                                                                new ArithmExpression(
                                                                    new HeapReadExpression(new VarExpression("v1")),
                                                                    ArithmeticalOperator.MUL,
                                                                    new ValueExpression(new IntValue(10))
                                                                )
                                                            ),
                                                            new PrintStatement(new HeapReadExpression(new VarExpression("v1")))
                                                        )
                                                    )
                                                ),
                                                new CompStatement(
                                                        ...
                                                        new CompStatement(
                                                            ...
                                                            new CompStatement(
                                                                new HeapWriteStatement("v2",
                                                                    new ArithmExpression(
                                                                        new HeapReadExpression(new VarExpression("v2")),
                                                                        ArithmeticalOperator.MUL,
                                                                        new ValueExpression(new IntValue(10))
                                                                    )
                                                                ),
                                                                new CompStatement(
                                                                    ...
                                                                    new PrintStatement(new HeapReadExpression(new VarExpression("v2")))
                                                                )
                                                            )
                                                        )
                                                    ),
                                                    new CompStatement(
                                                        new AwaitStatement("cnt"),
                                                        new PrintStatement(new HeapReadExpression(new VarExpression("v3")))
                                                    )
                                                )
                                            )
                                        )
